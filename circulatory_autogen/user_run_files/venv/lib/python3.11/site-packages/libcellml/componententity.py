...
class ComponentEntity(libcellml.namedentity.NamedEntity):
    ...
    def removeEncapsulationId(self):
        r"""Removes the encapsulation identifier for this entity."""
        return _componententity.ComponentEntity_removeEncapsulationId(self)
