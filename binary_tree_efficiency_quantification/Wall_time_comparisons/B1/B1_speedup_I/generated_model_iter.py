...
def _iter_residual(H_means, t, y):
    ...
    res[2] = ((inlet__v*inlet__H_volume_L-inlet__v_d*inlet__H_volume_R)) - H_means[2] * ((inlet__q)*(inlet__v+inlet__v_d))
    _flow = abs(inlet__v) + abs(inlet__v_d)
    _gate = ZERO_FLOW_REG_EPS**2 / (_flow**2 + ZERO_FLOW_REG_EPS**2 + 1e-300)
    res[2] += _gate * ZERO_FLOW_ANCHOR_STRENGTH * (inlet__H_global_L - H_means[2])
    return res
...
def ode_rhs(t, y):
    ...
    dydt[15] = (V1__H_L_out_RHS-V1__H_link_R)/V1__tau_link
    dydt[16] = (PV1__H_R_out-V1__H_link_L)/V1__tau_link
    dydt[17] = (V1__H_down_target-V1__H_down)/V1__tau_H_down
    dydt[18] = PV1__v_d*V1__H_volume_L-V1__v*V1__H_volume_R
    dydt[19] = PV1__v_d-V1__v
    dydt[20] = (V2__H_L_out_RHS-V2__H_link_R)/V2__tau_link
    dydt[21] = (PV2__H_R_out-V2__H_link_L)/V2__tau_link
    dydt[22] = (V2__H_down_target-V2__H_down)/V2__tau_H_down
    dydt[23] = PV2__v_d*V2__H_volume_L-V2__v*V2__H_volume_R
    dydt[24] = PV2__v_d-V2__v
    return dydt
