...
def _iter_residual(H_means, t, y):
    ...
    V4__RBC_volume = y[42]
    V4__q_C = y[43]
    VV_junc3__RBC_volume = y[44]
    VV_junc3__q_C = y[45]
    VV_junc3__q_C_d = y[46]
    PV5__H_link_R = y[47]
    PV5__H_link_L = y[48]
    PV5__H_down = y[49]
    PV5__q_C = y[50]
    ...
    PV3__H_mean = H_means[2]
    PV4__H_mean = H_means[3]
    PV5__H_mean = H_means[4]
    PV6__H_mean = H_means[5]
    V1__H_mean = H_means[6]
    V2__H_mean = H_means[7]
    inlet__H_mean = H_means[8]
...
def ode_rhs(t, y):
    ...
    dydt[34] = (V3__H_L_out_RHS-V3__H_link_R)/V3__tau_link
    dydt[35] = (PV3__H_R_out-V3__H_link_L)/V3__tau_link
    dydt[36] = (V3__H_down_target-V3__H_down)/V3__tau_H_down
    dydt[37] = PV3__v_d*V3__H_volume_L-V3__v*V3__H_volume_R
    dydt[38] = PV3__v_d-V3__v
    dydt[39] = (V4__H_L_out_RHS-V4__H_link_R)/V4__tau_link
    dydt[40] = (PV4__H_R_out-V4__H_link_L)/V4__tau_link
    dydt[41] = (V4__H_down_target-V4__H_down)/V4__tau_H_down
    dydt[42] = PV4__v_d*V4__H_volume_L-V4__v*V4__H_volume_R
    dydt[43] = PV4__v_d-V4__v
    dydt[44] = VV_junc3__RBC_in-VV_junc3__RBC_out
    dydt[45] = V2__v+VV_junc3__vbc2-VV_junc3__v
    dydt[46] = VV_junc3__v-PV5__v-PV6__v
    dydt[47] = (V5__H_L_out-PV5__H_link_R)/PV5__tau_link
    dydt[48] = (VV_junc3__H_from3-PV5__H_link_L)/PV5__tau_link
    dydt[49] = (PV5__H_down_target-PV5__H_down)/PV5__tau_H_down
    dydt[50] = PV5__v-PV5__v_d
    dydt[51] = (V6__H_L_out-PV6__H_link_R)/PV6__tau_link
    dydt[52] = (VV_junc3__H_from4-PV6__H_link_L)/PV6__tau_link
    dydt[53] = (PV6__H_down_target-PV6__H_down)/PV6__tau_H_down
    dydt[54] = PV6__v-PV6__v_d
    dydt[55] = (V5__H_L_out_RHS-V5__H_link_R)/V5__tau_link
    dydt[56] = (PV5__H_R_out-V5__H_link_L)/V5__tau_link
    dydt[57] = (V5__H_down_target-V5__H_down)/V5__tau_H_down
    dydt[58] = PV5__v_d*V5__H_volume_L-V5__v*V5__H_volume_R
    dydt[59] = PV5__v_d-V5__v
    dydt[60] = (V6__H_L_out_RHS-V6__H_link_R)/V6__tau_link
    dydt[61] = (PV6__H_R_out-V6__H_link_L)/V6__tau_link
    dydt[62] = (V6__H_down_target-V6__H_down)/V6__tau_H_down
    dydt[63] = PV6__v_d*V6__H_volume_L-V6__v*V6__H_volume_R
    dydt[64] = PV6__v_d-V6__v
    return dydt
